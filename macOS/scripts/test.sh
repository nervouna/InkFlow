...
xcrun clang -fobjc-arc -Wall -Wextra -Werror -mmacosx-version-min=13.0 -I macOS/Sources -I build/deps/dist/include macOS/Sources/Engine.m macOS/Sources/Settings.m macOS/Sources/InputController.m macOS/Tests/ControllerTests.m -framework AppKit -framework InputMethodKit -framework Carbon -L build/deps/dist/lib -lrime -Wl,-rpath,"$PWD/build/deps/dist/lib" -o build/controller-tests
build/controller-tests "$PWD/build/test-shared" "$user_dir"
xcrun clang -fobjc-arc -Wall -Wextra -Werror -mmacosx-version-min=13.0 -I macOS/Sources -I build/deps/dist/include macOS/Sources/Settings.m macOS/Tests/SettingsTests.m -framework AppKit -L build/deps/dist/lib -lrime -Wl,-rpath,"$PWD/build/deps/dist/lib" -o build/settings-tests
