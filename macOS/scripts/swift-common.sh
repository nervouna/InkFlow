...
ai_sources=(macOS/Sources/AIDiagnostics.swift macOS/Sources/AISettings.swift macOS/Sources/AIChatCompletions.swift macOS/Sources/SmartSettingsView.swift macOS/Sources/AIContext.swift macOS/Sources/AISuggestionCoordinator.swift macOS/Sources/AISuggestionPanel.swift)
