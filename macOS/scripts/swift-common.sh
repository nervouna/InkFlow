...
dictionary_update_sources=(macOS/Sources/StartupDiagnostics.swift macOS/Sources/DictionaryUpdateModels.swift macOS/Sources/DictionarySourceClient.swift macOS/Sources/DictionaryStore.swift macOS/Sources/PackagedCache.swift macOS/Sources/DictionaryWorkerProtocol.swift macOS/Sources/DictionaryWorkerRunner.swift)
ai_sources=(macOS/Sources/AIPronunciation.swift macOS/Sources/AIStatistics.swift macOS/Sources/AIStatisticsStore.swift macOS/Sources/AIDiagnostics.swift macOS/Sources/AISettings.swift macOS/Sources/AIChatCompletions.swift macOS/Sources/SmartSettingsView.swift macOS/Sources/AIContext.swift macOS/Sources/AISuggestionCoordinator.swift macOS/Sources/AISuggestionPanel.swift macOS/Sources/AIInputPresentation.swift macOS/Sources/EngineAI.swift macOS/Sources/InputControllerAI.swift)
swift_sources=(macOS/Sources/ApplicationLifecycle.swift macOS/Sources/QualityRecords.swift macOS/Sources/QualityStore.swift macOS/Sources/QualityRecorder.swift "${dictionary_sources[@]}" "${dictionary_update_sources[@]}" macOS/Sources/DictionaryCoordinator.swift macOS/Sources/Context.swift macOS/Sources/Engine.swift macOS/Sources/InputRankingContext.swift macOS/Sources/CandidatePresentation.swift macOS/Sources/Settings.swift macOS/Sources/DictionarySettings.swift macOS/Sources/CustomPhrases.swift macOS/Sources/InputController.swift macOS/Sources/InputControllerCore.swift)
