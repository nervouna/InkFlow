...
enum IFDictionaryGenerator {
    ...
    private static func parse(_ data: Data, source: String) throws -> [Row] {
        guard let string = String(data: data, encoding: .utf8), string.hasSuffix("\n") else {
            throw IFDictionaryError("source-format", source: source, "Expected complete UTF-8 dictionary with final newline")
        }
